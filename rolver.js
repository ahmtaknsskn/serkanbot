...
exports.run = async (client, message, args) => {
      ...
      if (!message.member.hasPermission("MANAGE_ROLES")) return message.channel.send(new Emran.MessageEmbed().setDescription('Bu Komudu Kullanmak İçin **Rolleri Yönet** Yetkisine sahip Olmak Gerekir.').setColor(10038562));
