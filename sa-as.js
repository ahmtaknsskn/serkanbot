...
exports.run = async (bot, message, args) => {
  if (!args[0]) return message.channel.send(`Aç yada kapat yazmalısın!! Örnek: **.otocevap aç**`)
  ...
  if (args[0] === 'aç') {
    ...
    message.channel.send(`Artık bot Sa diyince As diyecek. Kapatmak için "\`.otocevap kapat\`" yazmalısın.`)
