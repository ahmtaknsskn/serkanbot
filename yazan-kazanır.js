...
const words = ['çikolata', 'aggsy', 'odun', 'bomba', 'süt', 'şimşek', 'yıldırım', 'patlat', 'savaş', 'kelime', 'yok et', 'bilmem', 'öldür', 'sonsuzluk', 'gerçek'];
  ...
  if (opponent.bot) return msg.reply('Botlar ile oynayamazsın!');
		...
		try {
			...
			if (!verification) {
				...
				return msg.reply('Meydan okumana cevap gelmedi...');
			}
